...
public class AzureSpatialAnchorsScript : MonoBehaviour
{
    ...
    public async void VoiceCommand(string cmd)
    {
        tmp.text = "cmd:" + cmd;
        Debug.Log(cmd);
        if (cmd == "Set")
        {
            ...
            {
                tmp.text = "Session Started";
                Vector3 anchorPosition = new Vector3(0f, 0f, 0f);
                await CreateAnchor(anchorPosition);
            }
            else
            {
                tmp.text = "Session Failed";
            }
    ...
    private async Task CreateAnchor(Vector3 position)
    {
        ...
        tmp.text = "Start Collect Environment Data";
        ...
        try
        {
            ...
            if (!saveSucceeded)
            {
                ...
                tmp.text = "ASA - Failed to save, but no exception was thrown.";
                return;
            }
            ...
            ID = cloudSpatialAnchor.Identifier;
            tmp.text = cloudSpatialAnchor.Identifier;
