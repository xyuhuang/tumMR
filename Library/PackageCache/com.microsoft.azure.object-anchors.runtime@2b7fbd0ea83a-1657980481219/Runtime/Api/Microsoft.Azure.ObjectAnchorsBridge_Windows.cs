...
namespace Microsoft.Azure.ObjectAnchors
{
    ...
    internal static class ProjectedObjectEventHandlerCache
    {
        ...
        public static void AddEventHandler<T>(ulong cookie, string eventName, T handler)
            where T : Delegate
        {
            if (cookie == default)
            {
    ...
    internal static partial class NativeLibrary
    {
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        internal static extern Microsoft.Azure.ObjectAnchors.status aoa_object_observer_get_app_domain_unload_events(out System.IntPtr app_domain_unload_requested_ptr, out System.IntPtr app_domain_unload_completed_ptr);
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
    ...
    public partial class ObjectInstance : IDisposable, ICachedObject, IReferenceCounted
    {
        ...
        // Class extension begins for ObjectInstance.
        static ObjectInstance() => ObjectObserver.EnsureAppDomainUnloadHandlingInitialized();
        // Class extension ends for ObjectInstance.
    ...
    public partial class ObjectModel : IDisposable, ICachedObject, IReferenceCounted
    {
        ...
        // Class extension begins for ObjectModel.
        static ObjectModel() => ObjectObserver.EnsureAppDomainUnloadHandlingInitialized();
        // Class extension ends for ObjectModel.
    ...
    public partial class ObjectObserver : IDisposable, ICachedObject, IReferenceCounted
    {
        ...
        /// <summary>
        /// Internal method to facilitate unloading the module.
        /// </summary>
        private static void GetAppDomainUnloadEvents(out System.IntPtr appDomainUnloadRequestedPtr, out System.IntPtr appDomainUnloadCompletedPtr)
        {
            Microsoft.Azure.ObjectAnchors.NativeLibraryHelpers.CheckStatus(Microsoft.Azure.ObjectAnchors.NativeLibrary.aoa_object_observer_get_app_domain_unload_events(out appDomainUnloadRequestedPtr, out appDomainUnloadCompletedPtr));
        }
        ...
        // Class extension begins for ObjectObserver.
        ...
        static ObjectObserver()
        {
        #if !UNITY_2021_2_OR_NEWER
            IntPtr appDomainUnloadRequestedPtr;
            IntPtr appDomainUnloadCompletedPtr;
            GetAppDomainUnloadEvents(out appDomainUnloadRequestedPtr, out appDomainUnloadCompletedPtr);

            System.Threading.WaitHandleExtensions.SetSafeWaitHandle(_appDomainUnloadRequested, new Win32.SafeHandles.SafeWaitHandle(appDomainUnloadRequestedPtr, true));
            System.Threading.WaitHandleExtensions.SetSafeWaitHandle(_appDomainUnloadCompleted, new Win32.SafeHandles.SafeWaitHandle(appDomainUnloadCompletedPtr, true));

            if (!_appDomainUnloadRequested.SafeWaitHandle.IsInvalid &&
                !_appDomainUnloadCompleted.SafeWaitHandle.IsInvalid)
            {
                System.AppDomain.CurrentDomain.DomainUnload += OnAppDomainUnload;
            }
        #endif
        }
        ...
        {
            // Synchronously clean up collateral foreign threads which Mono leaves dangling.
            // Use eventing mechanism rather than P/Invoke since the trampolines are torn down at this point.
            _appDomainUnloadRequested.Set();
            _appDomainUnloadCompleted.WaitOne();
        }
        // Class extension ends for ObjectObserver.
    ...
    public partial class ObjectQuery : IDisposable, ICachedObject, IReferenceCounted
    {
        ...
        // Class extension begins for ObjectQuery.
        static ObjectQuery() => ObjectObserver.EnsureAppDomainUnloadHandlingInitialized();
        // Class extension ends for ObjectQuery.
...
namespace Microsoft.Azure.ObjectAnchors.SpatialGraph
{
    ...
    public partial class SpatialGraphPlacement : ICachedObject, IReferenceCounted
    {
        ...
        // Class extension begins for SpatialGraphPlacement.
        static SpatialGraphPlacement() => ObjectObserver.EnsureAppDomainUnloadHandlingInitialized();
        // Class extension ends for SpatialGraphPlacement.
...
namespace Microsoft.Azure.ObjectAnchors.Diagnostics
{
    ...
    public partial class ObjectDiagnosticsSession : ICachedObject, IReferenceCounted
    {
        ...
        // Class extension begins for ObjectDiagnosticsSession.
        static ObjectDiagnosticsSession() => ObjectObserver.EnsureAppDomainUnloadHandlingInitialized();
        // Class extension ends for ObjectDiagnosticsSession.
